...
'''
Real 8-ball rules (huge upgrade)
Predictive aiming with wall bounces
Slow-motion replay on good shots
...
while running:
    ...
    if game.state=="PLAYER":
        ...
        # ✅ MULTI-PASS collision (CRITICAL FIX)
        for _ in range(4):
